...
// File: contracts\AlfaTokenOffering.sol
...
contract AlfaTokenOffering is Pausable {
    ...
    // Whitelists of participant address for
    ...
    uint256 public constant FUNDING_ETH_HARD_CAP = 9000 * 1 ether;
    ...
    /**
     * Modifier that validates a purchase 
    ...
    modifier validPurchase() {
        ...
        require(contributionInWei >= MINIMUM_CONTRIBUTION);
        require(contributionInWei <= MAXIMUM_CONTRIBUTION);
     ...
     * Start the offering
     *
     * @param durationInMinutes of the offering after offering is started
     */
    function startOffering(uint256 durationInMinutes) public onlyOwner atStage(Stages.Setup) {
        stage = Stages.OfferingStarted;
        startTime = now;
        endTime = startTime.add(durationInMinutes * 60);
    ...
    /**
     * Internal function that buys token
     * 
     * Investiment limit changes over time:
     * 1) [offering starts]:     1x of contribution limit 
          *
     */
